...
PANTRY_FOR_SIMILARITY = {
    ...
    "salt black pepper", "salt pepper", "salt freshly black pepper", "freshly black pepper",
    "kosher salt",
}
...
ACTION_VERBS = [
    ...
    "refrigerate", "rinse", "roast", "season", "serve", "slice", "sprinkle", "squeeze", "stir",
    "toss", "transfer", "whisk"
]
...
def primary_action(step: str) -> str | None:
...
def action_sequence(value: object) -> list[str]:
    actions = (primary_action(step) for step in split_steps(value))
